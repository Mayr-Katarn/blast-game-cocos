import { log, _decorator, Component, Enum, Node, Prefab, Vec2, UITransform, math, CCInteger, PhysicsSystem2D, EPhysics2DDrawFlags, Vec3, instantiate } from 'cc';
...
export default class GameField extends Component {
    ...
    private _eventListener(isOn: boolean) {
        ...
        eventTarget[func](GameEvent.SET_CELL_EMPTY, this.onSetCellEmpty, this)
        eventTarget[func](GameEvent.SET_CELL_MATCH, this.onSetCellNoMatch, this)
    }
    ...
    private _createCell(row: number, col: number): void {
        ...
        cellNode.parent = this.cellsNode;
    ...
    private _resetBlockColors(): void {
        ...
        // TODO счетчик сбросов
        this.unscheduleAllCallbacks();
        eventTarget.emit(GameEvent.RESET_BLOCK_COLOR);
        this._initFieldMatchCheck();
    }
    ...
    private _checkEmptyCells(): void {
        ...
        // console.log('empty', topRow.length);
        topRow.forEach(cell => {
